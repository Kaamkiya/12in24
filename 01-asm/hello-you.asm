...
; You may have noticed that even though we don't force it to, the program prints a newline after the user's name
; This is because it counts the <Enter> key that the user used to submit their input as part of the name :)
